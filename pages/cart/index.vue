<template>
  <div class="cart_product">
    ...
    <div class="cart_product_content">
      ...
      <div class="row">
        <div class="col-md-12 show_cart"></div>
        <div
          class="col-md-12 show_cart"
          v-for="(cartItem, index) in mockDataCart"
          :key="index"
        >
          ...
          <div class="show_cart_information">
            ...
            <div class="action_variant">
              <div class="variant">
                <label for=""> Variasi: P001, TIPIS </label>
                <div class="money">Rp40.500</div>
              </div>
        ...
        <div class="col-md-4">
          <div class="total_purchasing">
            ...
            <div class="total_product">
              ...
              <div class="count">Rp.{{ totalCalculatePrice }}</div>
            </div>
            <div class="total_promo">
              <label for="">Potongan Promo</label>
              <div class="count">- Rp.{{ nominalPromo }}</div>
            </div>
        ...
        <div class="col-md-4 col-md-custom">
          <div class="checkout">
            <router-link to="/checkout">
              <b-button class="btn_checkout"> checkout </b-button>
            </router-link>
            <div class="whislist">
              <i class="far fa-heart" />
